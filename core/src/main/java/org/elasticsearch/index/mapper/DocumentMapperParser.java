...
public class DocumentMapperParser {
    ...
    public Mapper.TypeParser.ParserContext parserContext(String type, boolean parsingPartialData) {
        return new Mapper.TypeParser.ParserContext(type, analysisService, similarityLookupService, mapperService, typeParsers, indexVersionCreated, parseFieldMatcher, parsingPartialData);
    }

    public Mapper.TypeParser.ParserContext parserContext(String type) {
        return new Mapper.TypeParser.ParserContext(type, analysisService, similarityLookupService, mapperService, typeParsers, indexVersionCreated, parseFieldMatcher, false);
    }
    ...
    public DocumentMapper parse(@Nullable String type, CompressedXContent source, String defaultSource, boolean partialMappingData) throws MapperParsingException {
    ...
    private DocumentMapper parse(String type, Map<String, Object> mapping, String defaultSource, boolean partialMappingData) throws MapperParsingException {
        if (type == null) {
